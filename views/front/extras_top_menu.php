<?php switch ( $cur ) {
	case 'general': ?>
		...
		<span class="extra-subnav">
            ...
            <a href="<?php echo $group_link; ?>/fields/" class="button"><?php _e( 'All Fields', BPGE_I18N ); ?></a>
            <a href="<?php echo $group_link; ?>/pages/" class="button"><?php _e( 'All Pages', BPGE_I18N ); ?></a>
            <a href="<?php echo $group_link; ?>/fields-manage/" class="button"><?php _e( 'Add Field', BPGE_I18N ); ?></a>
