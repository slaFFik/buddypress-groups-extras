<li id="set-<?php echo $set->ID ?>">
    ...
    <span class="actions">
        <a class="button display_fields" set_fields="<?php echo $set->ID;?>" href="#"><?php _e('Show Fields', 'bpge'); ?> (<?php echo count($fields);?>)</a>
        <a class="button field_edit" data-set_id="<?php echo $set->ID;?>" href="#"><?php _e('Edit','bpge'); ?></a>
        <a class="button field_delete" data-fields_set="<?php echo $set->ID;?>" href="#"><?php _e('Delete','bpge'); ?></a>
    </span>
    ...
    <ul class="fields" id="fields_<?php echo $set->ID ?>" class="fields">
        ...
        <li><a class="button add_field" set_fields="<?php echo $set->ID;?>" href="#"><?php _e('Add field','bpge');?></a></li>
    </ul>
</li>